...
// Only throw error if env vars are missing and we're not in build mode
...
if (supabaseUrl && supabaseKey) {
  ...
  // During build phase, create a placeholder client to avoid errors
  supabaseClient = createClient('https://placeholder.supabase.co', 'placeholder-key')
} else {
  // Only throw in runtime if vars are truly missing
